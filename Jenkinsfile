pipeline {
    ...
    parameters {
        choice(choices: ['MySql','MSSQL', 'MSSQLDC', 'Postgres', 'Oracle','winjump','logrhythm','syslog','qradar','superna','superna-ubuntu','util','k8s', 'Oracle-rac', 'splunk'], description: 'Select the Solution to build', name: 'solution')
