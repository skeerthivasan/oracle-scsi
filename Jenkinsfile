pipeline {
    ...
    parameters {
        choice(choices: ['cowriter','MySql','MSSQL', 'MSSQLDC', 'Postgres', 'Oracle','winjump','logrhythm','syslog','qradar','superna','superna-ubuntu','util','k8s', 'Oracle-rac', 'splunk', 'superna-windows','superna-windows2','akriti-ubuntu', 'linux-ubuntu', 'spark', 'cyberark'], description: 'Select the Solution to build', name: 'solution')
